namespace GridViewDBAcess
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.parteFinalLocadoraTSQLDataSet = new GridViewDBAcess.ParteFinalLocadoraTSQLDataSet();
            this.carrosBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.carrosTableAdapter = new GridViewDBAcess.ParteFinalLocadoraTSQLDataSetTableAdapters.CarrosTableAdapter();
            this.parteFinalLocadoraTSQLDataSetBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.locacoesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.locacoesTableAdapter = new GridViewDBAcess.ParteFinalLocadoraTSQLDataSetTableAdapters.LocacoesTableAdapter();
            this.usuariosBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.usuariosTableAdapter = new GridViewDBAcess.ParteFinalLocadoraTSQLDataSetTableAdapters.UsuariosTableAdapter();
            this.estoqueBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.estoqueTableAdapter = new GridViewDBAcess.ParteFinalLocadoraTSQLDataSetTableAdapters.EstoqueTableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.parteFinalLocadoraTSQLDataSetBindingSource)).BeginInit();
            ...
            // 
            // parteFinalLocadoraTSQLDataSetBindingSource
            // 
            this.parteFinalLocadoraTSQLDataSetBindingSource.DataSource = this.parteFinalLocadoraTSQLDataSet;
            this.parteFinalLocadoraTSQLDataSetBindingSource.Position = 0;
            // 
            // locacoesBindingSource
            // 
            this.locacoesBindingSource.DataMember = "Locacoes";
            this.locacoesBindingSource.DataSource = this.parteFinalLocadoraTSQLDataSet;
            // 
            ...
            this.usuariosBindingSource.DataSource = this.parteFinalLocadoraTSQLDataSetBindingSource;
            // 
            ...
            this.estoqueBindingSource.DataSource = this.parteFinalLocadoraTSQLDataSet;
            // 
            // estoqueTableAdapter
            // 
            ...
            this.carrosBindingSource1.DataSource = this.parteFinalLocadoraTSQLDataSet;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.parteFinalLocadoraTSQLDataSetBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource parteFinalLocadoraTSQLDataSetBindingSource;
        private System.Windows.Forms.BindingSource locacoesBindingSource;
        private ParteFinalLocadoraTSQLDataSetTableAdapters.LocacoesTableAdapter locacoesTableAdapter;
        ...
        private ParteFinalLocadoraTSQLDataSetTableAdapters.EstoqueTableAdapter estoqueTableAdapter;
